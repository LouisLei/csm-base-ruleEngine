...
public interface PolicyRepository extends CrudRepository<PolicyEntity, String> {
   ...
   */
  @Modifying
  @Query(value="update R_POLICY set policyEnabled = 1 where policyId = :policyId" , nativeQuery=true)
   ...
   */
  @Modifying
  @Query(value="update R_POLICY set policyEnabled = 0 where policyId = :policyId" , nativeQuery=true)
